...
class ArtActivity : AppCompatActivity() {
    ...
    fun makeSmallerBitmap (image: Bitmap, maxSize : Int) : Bitmap {
        //genişlik ve yükseliği al, oranlara göre yatay mı düşey mi tespit et.
    ...
    fun selectImage(view: View) {
        ...
        //önceden istenip istenmediği kontrol edilir.
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == 1) {
            ...
            //granted results boş değilse ve izin verildiyse;
    ...
    //galeriye gitti, geri geldi ve resim seçtiyse
